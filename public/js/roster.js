            ...
            bodyRow.append(`
                <td class="${getIRNameRoster(item.data[time]) == '' ? '' : 'has_data'}">
                        ...
                        <div class="dropdown menu w-52 rounded-box bg-base-100 shadow-sm" popover id="popover-${i}" style="position-anchor:--anchor-${i}">
                            <div class="txt mb-3">
                                <input type="text" class="input" value="${getIRNameRoster(item.data[time])}" onkeyup='rosterChanged(this)' onchange='rosterUpdate(this,"${item.day}","${time}")'>
                            </div>
                            <div class="drop mb-3">
                            ...
                            <div class="d-grid">
                                <button class="btn btn-clear-roster-data btn-error btn-soft btn-block" onclick='clearRosterData(this,"${item.day}","${time}")'>Clear</button>
                            </div>
                        </div>
                </td>`);
            i++;
